...
#define LS_DEBUG SET_FG(80, 200, 80) "[DEBUG]: "
...
#define LS_LEAKS SET_FG(230, 230, 230) "[LEAKS]: " 
#define LS_NONE SET_FG(230, 230, 230) 
...
#define YOUT(message, ...) LogOutput(LOG_LEVEL_NONE, message, ##__VA_ARGS__);
